...
class ZingnewsPage(SaviorBasePage):
    VIDEO_AREA = (By.CSS_SELECTOR, 'div[class="player"]')
    ...
    # VIDEO_DURATION = (By.CSS_SELECTOR, 'div[class="player"] div[class="--z--control --z--control-time"] span:nth-child(3)')
    VIDEO_DURATION = (By.XPATH, '//*[@id="video-featured"]//div/div[2]/div/div[2]/div[2]/span[3]')

    def open_zingnews(self, url):
        self.get_url(url)
        time.sleep(3)
