...
class PhimdinhcaoPage(SaviorBasePage):
    FIRST_VIDEO = (By.CSS_SELECTOR, 'body > div:nth-child(7) li:nth-child(1) img')
    PLAY_VIDEO = (By.CSS_SELECTOR, 'a[id="btn-film-watch"]')
